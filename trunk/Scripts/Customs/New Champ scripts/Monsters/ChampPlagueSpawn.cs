...
namespace Server.Mobiles
{
	...
	public class ChampPlagueSpawn : BaseCreature
	{
		...
		public ChampPlagueSpawn() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ChampPlagueSpawn( Serial serial ) : base( serial )
		{
		}
