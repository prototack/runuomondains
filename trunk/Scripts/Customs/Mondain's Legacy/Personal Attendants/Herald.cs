...
namespace Server.Mobiles
{
	...
	{		
		public virtual TimeSpan YellDelay{ get{ return TimeSpan.FromSeconds( 15 ); } }

		private static HeraldEntry[] m_Announcements = new HeraldEntry[]
		{
		...
		private static HeraldEntry[] m_Greetings = new HeraldEntry[]
		{
		...
		public AttendantHerald( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			{
				if ( ControlOrder == OrderType.Follow && m_NextYell < DateTime.Now && m != ControlMaster && m_Announcement != null )
				{
					m_Announcement.Say( this, m );
					m_NextYell = DateTime.Now + YellDelay + TimeSpan.FromSeconds( Utility.RandomMinMax( -2, 2 ) );
				}
		...
		public class HeraldEntry
		{
			...
			public HeraldEntry() : this( null, null )
			{
			}

			public HeraldEntry( TextDefinition message ) : this( message, null )
			{
			}
		...
		{
			private AttendantHerald m_Herald;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				{
					case 3: m_Herald.SetAnnouncementText( m ); break;
					case 4: m_Herald.SetGreetingText( m ); break;
					case 5: 
					{
		...
		{
			private AttendantHerald m_Herald;
			private HeraldEntry[] m_Entries;
			private bool m_Announcement;
	...
	{		
		[Constructable]
		public AttendantMaleHerald() : base()
		{
		}
		
		public AttendantMaleHerald( Serial serial ) : base( serial )
		{
		}
	...
	{		
		[Constructable]
		public AttendantFemaleHerald() : base()
		{
		}
		
		public AttendantFemaleHerald( Serial serial ) : base( serial )
		{
		}
...
namespace Server.ContextMenus
{
	...
	{
		private AttendantHerald m_Attendant;
