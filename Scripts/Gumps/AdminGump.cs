                ...
                case AdminGumpPage.Administer_WorldBuilding:
                    {
                        ...
                        #region Sender
                        AddButton(10, 175 - 1 + 5, 10006, 10006, GetButtonID(3, 131), GumpButtonType.Reply, 0); // TelGenDelete
                        AddButton(210, 175 - 1 + 5, 10006, 10006, GetButtonID(3, 132), GumpButtonType.Reply, 0); // MoonGenDelete
                        AddButton(10, 200 - 1 + 5, 10006, 10006, GetButtonID(3, 133), GumpButtonType.Reply, 0); // UOAMVendorsDelete
                        AddButton(10, 225 - 1 + 5, 10006, 10006, GetButtonID(3, 134), GumpButtonType.Reply, 0); // DoorGenDelete
                        AddButton(210, 225 - 1 + 5, 10006, 10006, GetButtonID(3, 135), GumpButtonType.Reply, 0); // SignGenDelete
                        AddButton(210, 200 - 1 + 5, 10006, 10006, GetButtonID(3, 136), GumpButtonType.Reply, 0); // DecorateDelete
                        #endregion
                ...
                case AdminGumpPage.Accounts:
                    {
                        ...
                        AddLabelCropped(250, 120, 120, 20, LabelHue, "Status");
                        ...
                        for (int i = 0, index = (listPage * 12); i < 12 && index >= 0 && index < m_List.Count; ++i, ++index)
                        {
                            ...
                            if (online)
                                AddLabelCropped(250, offset, 120, 20, GreenHue, "On - " + a.LastLogin.ToString("d"));
                            else if (a.Banned)
                                AddLabelCropped(250, offset, 120, 20, RedHue, "Ban - " + a.LastLogin.ToString("d"));
                            else
                                AddLabelCropped(250, offset, 120, 20, RedHue, "Off - " + a.LastLogin.ToString("d"));
                ...
                case 3:
                    {
                        ...
                        switch (index)
                        {
                            ...
                            // + Sender
                            case 131: InvokeCommand("TelGenDelete"); notice = "Teleporters have been deleted."; break;
                            case 132: InvokeCommand("MoonGenDelete"); notice = "Moongates have been deleted."; break;
                            case 133: InvokeCommand("UOAMVendorsDelete"); notice = "Vendor spawners have been deleted."; break;
                            case 134: InvokeCommand("DoorGenDelete"); notice = "Doors have been deleted."; break;
                            case 135: InvokeCommand("SignGenDelete"); notice = "Signs have been deleted."; break;
                            case 136: InvokeCommand("DecorateDelete"); notice = "Decoration has been deleted."; break;
                            case 137: InvokeCommand("DecorateML"); notice = "Mondain's Legacy has been Generated."; break;
                            case 138: InvokeCommand("DecorateMLDelete"); notice = "Mondain's Legacy has been removed."; break;
                            // - Sender
