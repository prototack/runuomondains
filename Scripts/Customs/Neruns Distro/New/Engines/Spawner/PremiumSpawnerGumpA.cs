...
{
	public class PremiumSpawnerGumpA : Gump
	{
		...
		public PremiumSpawnerGumpA( PremiumSpawner spawner ) : base( 50, 50 )
		{
			m_Spawner = spawner;
		...
		{
			List<string> subSpawnerA = new List<string>();
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				...
				case 1: // Okay
				{
					m_Spawner.SubSpawnerA = CreateArray( info, state.Mobile );
