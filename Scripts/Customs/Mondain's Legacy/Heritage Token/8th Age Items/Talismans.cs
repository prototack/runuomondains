...
namespace Server.Items
{
	...
	public class BaseFormTalisman : Item
	{
		...
		[Constructable]
		public BaseFormTalisman( TalismanForm form ) : base( 0x2F59 )
		{
			m_Form = form;
		...
		{
			list.Add( 1075200, String.Format( "#{0}", (int) m_Form ) );
		}
	...
	{
		[Constructable]
		public FerretFormTalisman() : base( TalismanForm.Ferret )
		{
		}
	...
	{
		[Constructable]
		public SquirrelFormTalisman () : base( TalismanForm.Squirrel )
		{
		}
	...
	{
		[Constructable]
		public CuSidheFormTalisman() : base( TalismanForm.CuSidhe )
		{
		}
	...
	{
		[Constructable]
		public ReptalonFormTalisman() : base( TalismanForm.Reptalon )
		{
		}
