...
namespace Server.Items
{
	public class BrokenBedAddon : BaseAddon
	{
		...
		public BrokenBedAddon( bool east ) : base()
		{
			if ( east ) // east
			{
				AddComponent( new LocalizedAddonComponent( 0xC26, 1076263 ), 0, 0, 0 );
				AddComponent( new LocalizedAddonComponent( 0xC27, 1076263 ), 1, -1, 0 );
				AddComponent( new LocalizedAddonComponent( 0xC28, 1076263 ), 2, -2, 0 );
			}
			else 		// south
			{
				AddComponent( new LocalizedAddonComponent( 0xC29, 1076263 ), 0, 0, 0 );
				AddComponent( new LocalizedAddonComponent( 0xC2A, 1076263 ), -1, 1, 0 );
				AddComponent( new LocalizedAddonComponent( 0xC2B, 1076263 ), -2, 2, 0 );	
			}
		}
