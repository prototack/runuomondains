...
namespace Server.Items
{
	public class UnknownBardSkeleton : BaseContainer
	{
		...
		public UnknownBardSkeleton( Serial serial ) : base( serial )
		{
		}
	...
	public class UnknownRogueSkeleton : BaseContainer
	{
		...
		public UnknownRogueSkeleton() : base( 0xECA + Utility.Random( 9 ) )
		{
			...
			DropItem( new TreasureMap( Utility.RandomMinMax( 3, 5 ), Map.Trammel ) );
		}

		public UnknownRogueSkeleton( Serial serial ) : base( serial )
		{
		}
	...
	public class UnknownMageSkeleton : BaseContainer
	{
		...
		public UnknownMageSkeleton( Serial serial ) : base( serial )
		{
		}
